...
public abstract class Meta {
    ...
    private final String packageName = getPackageNameFromMeta();
    private final String className = getClassNameFromMeta();
    private final Map<String, Class<?>> fields = new HashMap<>();
    private final Set<List<Map.Entry<String, Class<?>>>> constructors = new HashSet<>();
